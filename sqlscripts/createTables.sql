...
select users.id as userid,users.first_name,users.last_name,
users.division,users.department,users.usertype,suggestions.id as sugid,
suggestions.suggestion,suggestions.created_at,suggestions.updated_at
from users join user_suggestion on users.id=user_suggestion.user_id
